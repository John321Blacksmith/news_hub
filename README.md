This project represents a web application that does collect news from different sources. There is also an accounts system so the user can leave his comments and vote on the news.
